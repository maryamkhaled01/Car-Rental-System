...
<body style="margin: 0px;">
        ...
        <div class="topnav" style="width: 100%; padding: 0px;">
            ...
            <a class="active" href="pickup.php">Pickups</a>
        ...
        <?php
            ...
            $sql = "SELECT * FROM car as c NATURAL JOIN reservation as r WHERE picked_up='0'"; 
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><th>car ID</th><th>plate ID</th><th>model</th><th>color</th><th>price/hour</th><th>cust ID</th><th>res date</th><th>pick up loc</th><th>pickedUp</th></tr>";
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<form action='pickup_aux.php' method='post'>";
                    ...
                    echo "<td><button type='submit'>picked up</button></td>";
                    echo "</form>";
                    echo "</tr>";
                }
                echo "</table>";
